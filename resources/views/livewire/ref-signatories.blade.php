                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr wire:key="item-{{ $item->id }}">
                            ...
                            <td>
                                <button class="btn btn-sm btn-warning text-start" wire:click="edit('{{ $item->id }}')">
        ...
        <div class="modal-dialog">
            <div class="modal-content text-start">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" style="background-color: #0A927C; border-color: #0A927C;" wire:loading.attr="disabled" wire:target="save, update, signature">Save changes</button>
                </div>
                </form>
            </div>
        </div>
